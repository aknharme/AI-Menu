  ...
  categories: [
    {
      ...
      products: [
        ...
        // 29 Nisan 2026: Yeni waffle ürünü eklendi
        {
          ...
          description: 'Yumuşak waffle içine çikolatalı krispiler, çikolata sosu ve dondurma.',
          price: 280,
    ...
    },
    {
      ...
      products: [
        ...
        // 29 Nisan 2026: Kahve kategorisine 3 yeni kahve ürünü eklendi (Espresso, Cappuccino, Macchiato)
        {
          ...
          categoryName: 'Kahve İçecek',
          name: 'Espresso',
          description: 'Koyu, yoğun kahve. Saf ve güçlü tadı ile kahve severler için ideal.',
          price: 95,
          tags: ['kahve', 'sade'],
        },
        {
    ...
    // 29 Nisan 2026: Burger kategorisi tamamen yeni eklendi (6 burger ürünü)
    {
      ...
      products: [
        ...
        },
        {
          ...
          description: 'Acı baharatlarla marine edilmiş tavuk, jalapeño ve acı sos ile ateşli burger.',
          price: 275,
          tags: ['tavuk', 'acılı'],
        },
      ],
