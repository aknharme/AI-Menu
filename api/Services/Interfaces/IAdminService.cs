...
public interface IAdminService
{
    ...
    Task<bool?> DeleteCategoryAsync(Guid categoryId, Guid restaurantId, CancellationToken cancellationToken = default);
    ...
    Task<bool?> DeleteProductAsync(Guid productId, Guid restaurantId, CancellationToken cancellationToken = default);
    ...
    Task<bool?> DeleteTableAsync(Guid tableId, Guid restaurantId, CancellationToken cancellationToken = default);
}
