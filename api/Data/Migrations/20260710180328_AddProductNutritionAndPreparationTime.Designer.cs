...
namespace AiMenu.Api.Data.Migrations
{
    ...
    [Migration("20260710180328_AddProductNutritionAndPreparationTime")]
    partial class AddProductNutritionAndPreparationTime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AiMenu.Api.Entities.Tag", b =>
                {
                    b.Property<Guid>("TagId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AiMenu.Api.Entities.ProductTag", b =>
                {
                    ...
                    b.HasOne("AiMenu.Api.Entities.Tag", "Tag")
                        .WithMany("ProductTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
